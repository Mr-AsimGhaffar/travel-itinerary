...
export default function TripPage() {
  ...
  return (
    <>
      <div className="min-h-screen p-6 mt-8 max-w-4xl mx-auto bg-white shadow-lg rounded-xl">
        <h1 className="text-xl md:text-3xl font-extrabold text-rose-700 mb-6 text-center">
          Saved Itinerary
        </h1>
        ...
        {tripData && (
          <>
            <section className="mb-8">
              <h2 className="text-lg md:text-2xl font-semibold text-rose-700 mb-2">
                Overview
              </h2>
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-2xl font-semibold text-rose-700 mb-4">
                Daily Plan
              </h2>
              <Collapse accordion className="bg-white">
                {tripData.days.map((day, index) => (
                  <Panel
                    ...
                    key={index}
                    className="bg-gray-50 border border-gray-200 rounded-lg text-sm md:text-base"
                  >
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 text-gray-800">
                {Object.entries(tripData.costs).map(([key, value]) => (
                  <li key={key}>
                    <span className="text-gray-900 text-rose-700 text-base md:text-xl">
                      {formatString(key)}:
                    </span>{" "}
